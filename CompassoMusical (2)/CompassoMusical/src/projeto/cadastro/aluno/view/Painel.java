		...
		mntmNewMenuItem_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						Leitor.setDiscAluno(((String) cmbCurso.getSelectedItem()));
						Leitor.setPerAluno((String) cmbCampus.getSelectedItem());
						...
						Leitor.setFalAluno(Integer.parseInt(lblFalta.getText()));
		...
		mntmNewMenuItem_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					lblPesq3.setText("Curso: " + Leitor.getDiscAluno());
